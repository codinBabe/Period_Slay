        ...
        <div className="flex m-0 relative align-center justify-center">
          <div>
            <div className="relative ">
              <div
                className="w-30 h-13 absolute text-primary500 text-6xl text-justify left-20 
                top-20 font-bold tracking-normal font-DmSerif leading-normal"
              >
                Learn About Period
        ...
        <div className="flex flex-col gap-40 pl-10 mt-20 ml-10">
            ...
            <div className="w-80, h-30 leading-6 pl-2 ml-10">
              <div className="w-30flex flex-col mr-20 right-10 absolute">
                ...
                <div className="bg-white p-5 w-30 h-30">
                  <h1 className="text-primary500 text-2xl font-bold">
                    What We Do
                  </h1>
                  <p>
                    ...
                    <br />
                    surrounding menstrual health. From
                    <br />
                ...
                <div className="p-10 bg-primary500 w-80 h-80 rounded-xl justify-center items-center  ring-1 gap-5 mt-60">
                  ...
                  <div className="flex flex-col ml-5 gap-5">
                    ...
                    <div className="flex gap-5 text-white">
                      <img src={TablerMail} alt="" srcset="" />
                      hello@periodslayer.com
                    </div>
                  </div>
                </div>
              </div>
              ...
              <section className="">
                ...
                <br /> individuals and communities by breaking down barriers to
                menstrual
                <br /> health and hygiene. We believe that everyone deserves
                access to safe and
                <br /> dignified menstrual care, regardless of their background
                or
                <br /> circumstances.
                <p>
                  <br />
                  ...
                  eradicate
                  <br />
                  menstrual poverty, promote menstrual health education, and
                  advocate for
                  <br />
                  menstrual equity worldwide. We're committed to ensuring that
                  no one
                  <br />
                  ever has to choose between their health and other basic
                  necessities.
                </p>
              </section>
            </div>
          ...
          <div className="">
            <div className=" ">
              ...
              <div className="w-50 h-50 leading-8 max-w-fit bg-neutral ml-80  -mt-20 ">
                <div>
                ...
                <div className="text-sm leading-8">
                  <p>
                    ...
                    <br /> globe. From marginalized communities in remote
                    villages to urban centers facing economic
                    <br />
                    hardship, we've made it our mission to reach those who need
                    our support the most. By
                    <br />
                    providing access to menstrual products, promoting menstrual
                    health education, and
                    <br />
                    challenging stigma and discrimination, we're creating a
                    world where menstruation is no
                    <br />
          ...
          <div className="leading-8 align-justify bg-neutral -ml-0 pt-3 -mt-20 w-2/3 ">
            <div>
            ...
            <div className="text-sm leading-8">
              <p>
                ...
                communities in
                <br />
                remote villages to urban centers facing economic hardship, we've
                made it our mission to reach those who need our support the
                most. By
                <br />
                providing access to menstrual products, promoting menstrual
                health education, and challenging stigma and discrimination,
                we're creating a
                <br />
                world where menstruation is no longer a barrier to health,
          ...
          <div className=" font-Jost leading-8 align-justify bg-neutral -ml-0 pt-3 -mt-10 mb-5 w-2/3">
            ...
            <div className="text-sm leading-8">
              ...
              <br />
              remote villages to urban centers facing economic hardship, we've
              made it our mission to reach those who need our support the most.
              By
              <br />
              providing access to menstrual products, promoting menstrual health
              education, and challenging stigma and discrimination, we're
              creating a
              <br />
              world where menstruation is no longer a barrier to health,
              dignity, and opportunity.
