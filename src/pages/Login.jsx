                    ...
                    <div className='max-w-3xl w-1/2 px-4 relative z-10'>
                        <div className='bg-white rounded-xl p-12 shadow-2xl transform translate-x-[73%]'>
                            ...
                            <form className='form' onSubmit={handleLogin}>
                                ...
                                <Link to='/forget' className='block text-xl mb-6 text-right'>Forgot password?</Link>
                            ...
                            <div className='text-center'>
                                ...
                                <p className='text-xl'>Don’t have an account yet? <Link className='text-primary500' to='/signup'>Sign up</Link></p>
                            </div>
                        </div>
                    </div>
